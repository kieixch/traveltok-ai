...
class TrendScoreService {
  get weights(): TrendWeights {
    return {
      growth: envNumber("TREND_WEIGHT_GROWTH", 0.3),
      engagement: envNumber("TREND_WEIGHT_ENGAGEMENT", 0.25),
      frequency: envNumber("TREND_WEIGHT_FREQUENCY", 0.2),
      recency: envNumber("TREND_WEIGHT_RECENCY", 0.15),
      contentGap: envNumber("TREND_WEIGHT_CONTENT_GAP", 0.1),
    };
  }
