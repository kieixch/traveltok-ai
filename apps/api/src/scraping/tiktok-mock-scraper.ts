...
/**
 * Deterministic mock scraper used when Apify credentials are absent
 * (SCRAPING_MODE=mock, the default). Produces realistic-looking travel data
 * seeded from the job's keyword/hashtag so re-runs are stable.
 */
@Injectable()
